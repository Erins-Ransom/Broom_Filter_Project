\title{A Survey of Adaptive AMQs}
\author{
...
\begin{abstract}
    ...
    item $x$ that has been inserted, i.e. $x\in {\bf S}$, the AMQ is guaranteed to
    ...
    The majority of current AMQs offer strong guarantees for independent
    queries; however, the false-positive probability rates for most can be
    pushed towards 1 given the right sequence of non-independent queries.  Some recent
